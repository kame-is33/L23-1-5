...
SPECIAL_QUERY_PATTERNS = {
    "employee": ["人事", "従業員", "社員", "部署", "スキル"],
    "finance": ["予算", "経費", "売上", "利益"],
    "project": ["プロジェクト", "案件", "計画"]
}
EMPLOYEE_DATA_PATH = "./data/社員について/社員名簿.csv"
...
INVALID_RESPONSE_ERROR = "無効な応答形式です。もう一度お試しください。"
RETRIEVER_NOT_INITIALIZED_ERROR = "情報検索システムの準備ができていません。"
